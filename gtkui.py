...
# gtkui.py
#
# Copyright (C) 2009 Troy Baird <halo779@gmail.com>
#
...
class GtkUI(GtkPluginBase):
    def enable(self):
        ...
        component.get("Preferences").add_page("RtorrentDelugeBridge", self.glade.get_widget("prefs_box"))
    ...
    def disable(self):
        component.get("Preferences").remove_page("RtorrentDelugeBridge")
    ...
    def on_apply_prefs(self):
        ...
        client.rtorrentdelugebridge.set_config(config)

    def on_show_prefs(self):
        client.rtorrentdelugebridge.get_config().addCallback(self.cb_get_config)
